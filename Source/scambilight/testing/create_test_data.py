...
def main():
    input_imgs = GetAllFilesInFolder_Recursive(r"C:\Working\nonwork\SCAMBILIGHT\real_fisheye_w_trackers_imgs")
   
    for index, img_filepath in enumerate(input_imgs): 
        print(img_filepath)
        ...
        while True:
            ...
            if res == "r":
                output = {}
                output["file"] = img_filepath
                output["points"] = mouse_handler.points
                filename = "D:/fish_eye_jsons/" + str(index) + ".json"
