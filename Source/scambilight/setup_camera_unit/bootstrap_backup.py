...
# MY_ID=0
# LUMOSCRIPT = "/home/scambiloop.py"
# ERRSCRIPT = "/home/err.py"
# url=""
# data=""


if os.path.exists("/home/scambilight/scambilight"):
    subprocess.run(['sudo', 'rm', '-r', '/home/scambilight/scambilight/'])#, shell=True) 
while os.path.exists("/home/scambilight/scambilight/") is False:
    print("trying to clone repo from web")
    subprocess.run(['git', 'clone' ,'https://github.com/LiellPlane/DJI_UE4_poc.git', '/home/scambilight/scambilight/'])#, shell=True)

#subprocess.Popen('sudo python /home/lumotag/DJI_UE4_poc/Source/lumotag/lumoscript.py', shell=True)

# Add the directory containing your module to the Python path (wants absolute paths)

sys.path.append(os.path.abspath("/home/scambilight/scambilight/Source/scambilight/"))
