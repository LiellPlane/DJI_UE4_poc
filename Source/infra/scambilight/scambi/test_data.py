event_good_session = {'body': '{"action":"getconfig","data":"doesnt matter for now but needs config id and maybe user","sessiontoken":"\\"fb1e6ead-e6b5-4dea-8921-f60e4c40b1es\\""}'}
event_bad_session = {'body': '{"action":"getconfig","data":"doesnt matter for now but needs config id and maybe user","sessiontoken":"\\"fb1e6ssssb1es\\""}'}
