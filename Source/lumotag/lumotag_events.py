...
"{player_name} will not echo in eternity",
"{player_name}: Zero sass detected.",
"{player_name}: not ready for this jelly",
"{player_name}: Inadequate pythons.",
"{player_name}: Title shot denied.",
"Behave yourself, {player_name}.",
"{player_name}: To bed without supper.",
"{player_name}: Most unseemly conduct.",
"For shame, {player_name}.",
"{player_name}: No pudding tonight.",
"Mind your manners, {player_name}.",
"Cease this nonsense, {player_name}.",
"{player_name}: Latin conjugations, now.",
"Father shall hear of this, {player_name}.",
"{player_name}: Recite scripture. Again.",
"{player_name}: Etiquette class extended.",
"{player_name}: Needlework until bedtime.",
"{player_name}: My affections lie elsewhere.",
"Unhand me, {player_name}.",
"{player_name}: You presume too much.",
"I think not, {player_name}.",
"{player_name}: Our stations differ greatly.",
"Impossible, dear {player_name}.",
"{player_name}: My heart belongs another.",
"Declined, {player_name}. Most firmly.",
"{player_name}: We are not suited.",
"{player_name}: I could never love thee.",
"{player_name}: That's life, pal.",
"Wise up, {player_name}.",
"{player_name}: My guardian disapproves.",
"Not you, {player_name}. Never you.",
"{player_name}: I am already promised.",
"Heavens no, {player_name}.",
"{player_name}: My reputation, sir!",
"I cannot, {player_name}. I shan't.",
"{player_name}: You're too late, darling.",
"{player_name}: What would people say?",
]